...
public class UpdateHouseholdSettlementController {
  ...
  public ResponseEntity registerHousehold(@AuthenticationPrincipal UserDetails userDetails,
    ...
    BigDecimal householdBudget =
            updateHouseholdSettlementUseCase.updateHouseholdSettlement(userEmail, budgetAmount, allowanceRatio);
    Notification notification = NotificationUtils.updateBudgetNotification(householdBudget);
